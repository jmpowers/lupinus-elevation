...
metadata <- load_metadata(lupmeta %>% select(-sample), sample="FileName", type="type")#was sample="sample"
...
chemsf$filter_final <- with(chemsf, (filter_RT == "OK" & filter_match=="OK" & filter_freq.floral == "OK" & 
                              filter_contaminant == "OK" & filter_area == "OK" & filter_ambient_ratio == "OK") | name=="indole")
